# When the Numbers Don't Add Up: A Reconciliation-Driven Data Quality Project
...
It then produced a ranked table (top companies by deviation — Clearwire at $4.7B, Verizon at $3.84B, Facebook at $1.5B, etc.), a plausible root cause for each, and a 5-step action checklist for a human analyst to follow up on. Full report in [`docs/ai_agent_report.md`](docs/ai_agent_report.md).
